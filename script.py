...
"""
    ...
    FEEDBACK_TEXT = "CONTACT MY DEV FOR 🖌FEEDBACK & REPORTING BUGS"
    CHANNEL_TEXT = "JOIN OUR UPDATES CHANNEL FOR OTHER BOTS🤖"
    GROUP_TEXT = " HI BRO HERE IS OUR GROUP LINK ,HERE YOU CAN REQUEST ANY 🎬MOVIES AND SERIES"
